      ...
      <div className="space-y-6 pb-6 md:pb-0 pt-6 px-6">
        ...
        <Card className="border border-border shadow-sm bg-card hover:shadow-md transition-shadow">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-muted-foreground">Disciplinas Completas</p>
                <h3 className="text-3xl font-bold text-card-foreground mt-2">
        ...
        <Card className="border border-border shadow-sm bg-card hover:shadow-md transition-shadow">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-muted-foreground">Total de PDFs</p>
                <h3 className="text-3xl font-bold text-card-foreground mt-2">
        ...
        <Card className="border border-border shadow-sm bg-card hover:shadow-md transition-shadow">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-muted-foreground">Total de Vídeos</p>
                <h3 className="text-3xl font-bold text-card-foreground mt-2">
