  ...
  return (
    <Card className="bg-card border-primary/15 h-full w-full">
      <CardContent className="flex flex-col items-center justify-center gap-1 px-3 py-3">
        {/* Ampulheta */}
        <svg viewBox="0 0 40 60" className="h-10 w-auto text-foreground" preserveAspectRatio="xMidYMid meet">
          <defs>
        ...
        <p className="text-xs text-muted-foreground leading-tight">Ciclo</p>
        <p className="text-2xl font-bold leading-tight">{Math.round(progress)}%</p>
      </CardContent>
    </Card>
  );
}
